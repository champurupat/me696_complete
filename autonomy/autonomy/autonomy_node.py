...
class PlaceholderController(Node):
    ...
    def __init__(self):
        ...
        self.dist_thresh_obs = 0.8 # in meters
         
        # Maximum left-turning speed    
        self.turning_speed = 0.4 # rad/s
        ...
        self.yaw_precision = 6.0 * (math.pi / 180) 
         
        # How quickly we need to turn when we need to make a heading
        # adjustment (rad/s)
        self.turning_speed_yaw_adjustment = 0.2
